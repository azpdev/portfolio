...
function openSideNav() {
  ...
  document.getElementById("side-nav").style.borderLeft = "4px solid var(--color-primary)";
  document.getElementById("side-nav-back").style.height = "100vh";
  document.getElementById("side-nav-back").style.width = "100vw";
}

window.addEventListener("load", () => {
  document.getElementById("open-nav-btn").addEventListener("click", openSideNav);
  document.getElementById("close-nav-btn").addEventListener("click", closeSideNav);
  document.getElementById("side-nav-back").addEventListener("click", closeSideNav);
});
